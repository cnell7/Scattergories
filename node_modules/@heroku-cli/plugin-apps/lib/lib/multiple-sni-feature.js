...
async function multipleSniEndpointsEnabled(heroku, appName) {
    const { body: featureList } = await heroku.get(`/apps/${appName}/features`);
...
exports.default = multipleSniEndpointsEnabled;

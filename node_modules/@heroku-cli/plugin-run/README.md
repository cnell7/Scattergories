...
@heroku-cli/plugin-run/7.43.0 darwin-x64 node-v12.15.0
$ heroku --help [COMMAND]
USAGE
  $ heroku COMMAND
...
...
_See code: [src/commands/logs.ts](https://github.com/heroku/cli/blob/v7.43.0/src/commands/logs.ts)_
...
_See code: [src/commands/run/index.ts](https://github.com/heroku/cli/blob/v7.43.0/src/commands/run/index.ts)_
...
_See code: [src/commands/run/detached.ts](https://github.com/heroku/cli/blob/v7.43.0/src/commands/run/detached.ts)_
<!-- commandsstop -->
